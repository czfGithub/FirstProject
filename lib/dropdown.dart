...
class TestDropdownButton<T> extends StatefulWidget {
...
class _DropdownButtonState<T> extends State<TestDropdownButton<T>> with WidgetsBindingObserver {
  int _selectedIndex;
  ...
  @override
  void didUpdateWidget(TestDropdownButton<T> oldWidget) {
